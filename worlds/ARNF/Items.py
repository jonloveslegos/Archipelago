...
for i in range(1, normal_total_locations-2):
    item_data_table[f"{normal_item_prefix}{i}"] = ARNFItemData(code = arnf_locations_start_id+i)
item_data_table[f"{progression_item_prefix}4"] = ARNFItemData(code = arnf_locations_start_id+normal_total_locations-2, type=ItemClassification.progression)
item_data_table[f"{progression_item_prefix}7"] = ARNFItemData(code = arnf_locations_start_id+normal_total_locations-1, type=ItemClassification.progression)
