...
from .Locations import arnf_locations_start_id, normal_total_locations, classic_boss_rush_offset, classic_boss_rush_total_locations, exterminator_offset, exterminator_total_locations
