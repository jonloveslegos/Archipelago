...
advancement_table = {
    ...
    "CH2: Lancer Cookie": AdvData(43, "CH2: Castle Town"),
    "CH2: Weird Route CD Bagel Box Item 1": AdvData(44, "CH2: City"),
    "CH2: Weird Route CD Bagel Box Item 2": AdvData(45, "CH2: City"),
    "CH2: Weird Route CD Bagel Box Item 3": AdvData(46, "CH2: City"),
    "CH2: Weird Route CD Bagel Box Item 4": AdvData(47, "CH2: City"),
    "CH2: Weird Route Pre-Fountain Refreshments": AdvData(48, "CH2: City"),
    "CH2: Queen Painting Chest": AdvData(49, "CH2: City"),
