...
location_table = {
    "Reinforced Endoskeleton": LocData(797197, "World", "ar1", "arHINT1"),
    "Steel Endoskeleton": LocData(797198, "World", "ar2", "arHINT2"),
    "Titanium Endoskeleton": LocData(797199, "World", "ar3", "arHINT3"),
    ...
    "Gnat": LocData(797269, "World", "p1", "pHINT1"),
    "Neon Bee": LocData(797270, "World", "p2", "pHINT2"),
    "Neon Wasp": LocData(797271, "World", "p3", "pHINT3"),
    "Medpod 1": LocData(797272, "World", "p4", "pHINT4"),
    "Medpod 2": LocData(797273, "World", "p5", "pHINT5"),
    "Mega-Med": LocData(797274, "World", "p6", "pHINT6"),
    "Mini-Reaper": LocData(797275, "World", "p7", "pHINT7"),
    "Reaper": LocData(797276, "World", "p8", "pHINT8"),
    "X-Reaper": LocData(797277, "World", "p9", "pHINT9"),
    "Mini-FO": LocData(797278, "World", "p10", "pHINT10"),
    "UFO": LocData(797279, "World", "p11", "pHINT11"),
    "X-FO": LocData(797280, "World", "p12", "pHINT12"),
    "Block5": LocData(797281, "World", "p13", "pHINT13"),
    "Block20": LocData(797282, "World", "p14", "pHINT14"),
    "Block50": LocData(797283, "World", "p15", "pHINT15"),
    "Pop-Pop": LocData(797284, "World", "p16", "pHINT16"),
    "BOOM!": LocData(797285, "World", "p17", "pHINT17"),
    "KABOOM!": LocData(797286, "World", "p18", "pHINT18"),
    "BossDrain01": LocData(797287, "World", "p19", "pHINT19"),
    "BossDrain02": LocData(797288, "World", "p20", "pHINT20"),
    "BossDrain-X": LocData(797289, "World", "p21", "pHINT21"),
}
