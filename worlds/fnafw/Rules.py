...
def _fnaf_world_can_access(state: CollectionState, player: int, name: str):
    if name == "Choppy's Woods":
        ...
        return _fnaf_world_can_access(state, player, "Lilygear Lake") and state.has("Blacktomb Yard Access Switch", player)
    else:
        return False
...
def set_rules(world: MultiWorld, player: int):
    ...
    # Always available
    set_rule(world.get_location("Balloon Boy", player), lambda state: True)
    set_rule(world.get_location("JJ", player), lambda state: True)
    set_rule(world.get_location("Phantom Freddy", player), lambda state: True)
    set_rule(world.get_location("Phantom Chica", player), lambda state: True)
    set_rule(world.get_location("Phantom BB", player), lambda state: True)
    ...
    set_rule(world.get_location("Lilygear Lake: Switch", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    ...
    set_rule(world.get_location("Withered Bonnie", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    set_rule(world.get_location("Withered Chica", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    set_rule(world.get_location("Withered Freddy", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    set_rule(world.get_location("Golden Freddy", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    set_rule(world.get_location("Paperpals", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    set_rule(world.get_location("Nightmare Freddy", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods"))
    set_rule(world.get_location("Crying Child", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods") and (world.hard_logic[player] or _fnaf_world_can_access(state, player, "Blacktomb Yard")))
    set_rule(world.get_location("Funtime Foxy", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods") and (world.hard_logic[player] or _fnaf_world_can_access(state, player, "Blacktomb Yard")))
    set_rule(world.get_location("Nightmare Fredbear", player), lambda state: _fnaf_world_can_access(state, player, "Choppy's Woods") and (world.hard_logic[player] or _fnaf_world_can_access(state, player, "Blacktomb Yard")))

    # Requires "Lilygear Lake Access Switch"
    set_rule(world.get_location("Shadow Freddy", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Marionette", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Phantom Marionette", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    ...
    set_rule(world.get_location("Nightmare Bonnie", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Nightmare Chica", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Nightmare Foxy", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Endo 01", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Endo 02", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Plushtrap", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Endoplush", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Springtrap", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("RWQ", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    set_rule(world.get_location("Blacktomb Yard: Switch", player), lambda state: _fnaf_world_can_access(state, player, "Lilygear Lake"))
    ...
    set_rule(world.get_location("Nightmare", player), lambda state: _fnaf_world_can_access(state, player, "Blacktomb Yard"))
    set_rule(world.get_location("Fredbear", player), lambda state: _fnaf_world_can_access(state, player, "Blacktomb Yard"))
    set_rule(world.get_location("Spring Bonnie", player), lambda state: _fnaf_world_can_access(state, player, "Blacktomb Yard"))
