...
item_table: Dict[str, ItemData] = {
    "Potion": ItemData(useful, 99, 0x194DCA),
    "Panel Slot": ItemData(useful, 105,0x194DC9),
    "Hi-Potion": ItemData(useful, 99,0x194DCB),
    "Mega-Potion": ItemData(useful, 99,0x194DCC),
    "Ether": ItemData(useful, 99,0x194DCD),
    "Hi-Ether": ItemData(useful, 99,0x194DCE),
    "Mega-Ether": ItemData(useful, 99,0x194DCF),
    "Elixir": ItemData(useful, 99,0x194DD0),
    "Megalixir": ItemData(useful, 99,0x194DD1),
    "Panacea": ItemData(useful, 99,0x194DD2),
    "Limit Recharge": ItemData(useful, 99,0x194DD3),
    ...
    "Fire": ItemData(useful, 20, 0x194E25),
    "Fira": ItemData(useful, 10, 0x194E26),
    "Firaga": ItemData(useful, 5, 0x194E27),
    "Blizzard": ItemData(useful,20, 0x194E28),
    "Blizzara": ItemData(useful,10,0x194E29),
    "Blizzaga": ItemData(useful,5,0x194E2A),
    "Thunder": ItemData(useful,20,0x194E2B),
    "Thundara": ItemData(useful,10,0x194E2C),
    "Thundaga": ItemData(useful,5,0x194E2D),
    "Aero": ItemData(useful,20,0x194E2E),
    "Aerora": ItemData(useful,10,0x194E2F),
    "Aeroga": ItemData(useful,5,0x194E30),
    "Cure": ItemData(useful,20,0x194E31),
    "Cura": ItemData(useful,10,0x194E32),
    ...
    "Ddoublecast 4": ItemData(useful, 1, 0x194E3A),
...
"Dodge Roll 3": ItemData(useful, 1, 0x194E3E),
    "Dodge Roll LV+": ItemData(useful,2,0x194E3F),
...
"Air Slide 2": ItemData(useful, 1, 0x194E58),
"Air Slide 5": ItemData(useful, 1, 0x194E59),
    "Air Slide LV+": ItemData(useful,4,0x194E5A),
"Air Rush": ItemData(useful, 1, 0x194E5B),
"Sliding Dash": ItemData(useful, 1, 0x194E62),
"Sliding Dash 3": ItemData(useful, 1, 0x194E63),
    "Sliding Dash LV+": ItemData(useful,2,0x194E64),
"Glide 3": ItemData(useful, 1, 0x194E52),
"Glide 5": ItemData(useful, 1, 0x194E53),
    "Glide LV+": ItemData(useful,4,0x194E54),
...
"High Jump": ItemData(useful, 1, 0x194E68),
"High Jump 3": ItemData(useful, 1, 0x194E69),
    "High Jump LV+": ItemData(useful,2,0x194E6A),
...
"Lucky Ring": ItemData(useful, 1, 0x194F9A),
...
"Flaggin Winds": ItemData(useful, 1, 0x194FBC),
...
"Sighting of the Moon": ItemData(useful, 1, 0x194FC0),
