...
item_table: Dict[str, ItemData] = {
    ...
    "Fire Recipe": ItemData(progression, 10, 0x194EC3),
    "Fira Recipe": ItemData(progression, 10, 0x194EC4),
    "Firaga Recipe": ItemData(progression, 10, 0x194EC5),
    "Blizzard Recipe": ItemData(progression, 10, 0x194EC6),
    "Blizzara Recipe": ItemData(progression, 10, 0x194EC7),
    "Blizzaga Recipe": ItemData(progression, 10, 0x194EC8),
    "Thunder Recipe": ItemData(progression, 10, 0x194EC9),
    "Thundara Recipe": ItemData(progression, 10, 0x194ECA),
    "Thundaga Recipe": ItemData(progression, 10, 0x194ECB),
    "Aero Recipe": ItemData(progression, 10, 0x194ECC),
    "Aerora Recipe": ItemData(progression, 10, 0x194ECD),
    "Aeroga Recipe": ItemData(progression, 10, 0x194ECE),
    "Cure Recipe": ItemData(progression, 10, 0x194ECF),
    "Cura Recipe": ItemData(progression, 10, 0x194ED0),
    "Curaga Recipe": ItemData(progression, 10, 0x194ED1),
    "Elixir Recipe": ItemData(progression, 10, 0x194EF9),
    "Megalixir Recipe": ItemData(progression, 10, 0x194EFA),
    "Shining Shard": ItemData(filler, 1, 0x194ED5),
    "Blazing Shard": ItemData(filler, 1, 0x194DD5),
    "Iron": ItemData(filler, 1, 0x194EFF),
    "Aerial Tech": ItemData(filler, 1, 0x194EDF),
    "Moonstone": ItemData(filler, 1, 0x194F08),
    "Frost Shard": ItemData(filler, 1, 0x194DD9),
    "Diamond": ItemData(filler, 1, 0x194F07),
    "Combo Tech": ItemData(filler, 1, 0x194EDC),
    "Lightning Shard": ItemData(filler, 1, 0x194DDD),
    "Gear Component A": ItemData(filler, 1, 0x194ED8),
    "Gust Shard": ItemData(filler, 1, 0x194ED2),
    "Bronze": ItemData(filler, 1, 0x194F00),
    "Shining Gem": ItemData(filler, 1, 0x194ED6),
    "Blazing Gem": ItemData(filler, 1, 0x194DD7),
    "Frost Gem": ItemData(filler, 1, 0x194DDB),
    "Gear Component B": ItemData(filler, 1, 0x194ED9),
    "Dark Ingot": ItemData(filler, 1, 0x194F01),

    "Lightning Gem": ItemData(filler, 1, 0x194DDF),
    "Silver": ItemData(filler, 1, 0x194F02),
    "Gust Gem": ItemData(filler, 1, 0x194ED3),
    "Gust Crystal": ItemData(filler, 1, 0x194ED4),
    "Gear Component C": ItemData(filler, 1, 0x194EDA),
    "Premium Orb": ItemData(filler, 1, 0x194F09),
    "Shining Crystal": ItemData(filler, 1, 0x194ED7),
    "Blazing Crystal": ItemData(filler, 1, 0x194DD8),
    "Gear Component D": ItemData(filler, 1, 0x194EDB),
    "Frost Crystal": ItemData(filler, 1, 0x194DDC),
    "Lightning Crystal": ItemData(filler, 1, 0x194DE0),
    "Gold": ItemData(filler, 1, 0x194F03),
    "Adamantite": ItemData(filler, 1, 0x194F06),
    "Luck Tech": ItemData(filler, 1, 0x194EF4),
}
