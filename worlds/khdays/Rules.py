    ...
    def days_has_count_access(self, state: CollectionState, item_name: str, req_count: int, player: int):
        ...
        if item_name == "Potion":
            ...
            if self.days_has_day_access(state, 256, player) and state.has("High Jump 3", player) and state.has(
                ...
                total += 1
            if self.days_has_day_access(state, 256, player) and self.days_shop_status(state, player) >= 1 and state.has("Cura", player, 4):
                total += 1
            if self.days_has_day_access(state, 299, player) and self.days_shop_status(state, player) >= 1 and state.has("Cura", player, 4):
                total += 1
            if self.days_has_day_access(state, 322, player) and self.days_shop_status(state, player) >= 1 and state.has("Cura", player, 4):
                total += 2
            ...
            if self.days_has_day_access(state, 224, player) and self.days_shop_status(state, player) >= 1 and state.has("Fira", player, 3):
                total += 1
            if self.days_has_day_access(state, 322, player) and self.days_shop_status(state, player) >= 1 and state.has("Fira", player, 3):
                total += 2
