...
advancement_table = {
    ...
    "Noodles Fridge": AdvData(79008, "room_fire_lab1"),
    "Pan Hidden": AdvData(79009, "room_fire6A"),
    "Apron Hidden": AdvData(79010, "room_fire_apron"),
    "Trash Burger": AdvData(79011, "room_fire_core_treasureleft"),
    "Present Knife": AdvData(79012, "room_asrielroom_final"),
    "Present Locket": AdvData(79013, "room_asrielroom_final"),
    ...
    "Dog Sale 1": AdvData(79026, "room_fire_hotdog"),
    "Cat Sale": AdvData(79027, "room_fire_hotdog"),
    "Dog Sale 2": AdvData(79028, "room_fire_hotdog"),
    "Dog Sale 3": AdvData(79029, "room_fire_hotdog"),
    "Dog Sale 4": AdvData(79030, "room_fire_hotdog"),
    "Chisps Machine": AdvData(79031, "room_fire_labelevator"),
    "Hush Trade": AdvData(79032, "room_fire_hoteldoors"),
    ...
    "Bratty Catty 1": AdvData(79042, "room_shop3"),
    "Bratty Catty 2": AdvData(79043, "room_shop3"),
    "Bratty Catty 3": AdvData(79044, "room_shop3"),
    "Bratty Catty 4": AdvData(79045, "room_shop3"),
    "Burgerpants 1": AdvData(79046, "room_shop4"),
    "Burgerpants 2": AdvData(79047, "room_shop4"),
    "Burgerpants 3": AdvData(79048, "room_shop4"),
    "Burgerpants 4": AdvData(79049, "room_shop4"),
    ...
    "True Lab Key": AdvData(79063, "room_fire_prelab"),
    ...
    "Diary 1": AdvData(79070, "room_water_hapstablook"),
    "Diary 2": AdvData(79071, "room_water_hapstablook"),
    "Diary 3": AdvData(79072, "room_water_hapstablook"),
    "Diary 4": AdvData(79073, "room_water_hapstablook"),
    "Diary 5": AdvData(79074, "room_water_hapstablook"),
    "Diary 6": AdvData(79075, "room_water_hapstablook"),
