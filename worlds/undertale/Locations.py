...
advancement_table = {
    ...
    "Snowdin Plot": AdvData(79054, "Ruins"),
    "Waterfall Plot": AdvData(79055, "Snowdin Town"),
    "Papyrus Plot": AdvData(79056, "papyrus\' Home Entrance"),
    "Undyne Plot": AdvData(79057, "undyne\'s Home Entrance"),
    "Hotland Plot": AdvData(79058, "Waterfall"),
    "Cooking Show Plot": AdvData(79059, "Hotland"),
    "TV Show Plot": AdvData(79060, "Hotland"),
